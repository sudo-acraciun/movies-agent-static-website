...
<svg xmlns="http://www.w3.org/2000/svg" width="1200" height="630" viewBox="0 0 1200 630">
  ...
  <text x="84" y="546" fill="#94A3B8" font-family="Segoe UI, Helvetica, Arial, sans-serif"
        font-size="31" font-weight="500">Find what to watch, together. Free on iPhone and Android.</text>
</svg>`;
    ...
    JSON.stringify(
      {
        ...
        description:
          'Free movie and TV app for iPhone and Android. Discover what to watch with an AI assistant, share one library with your household, and track everything you have seen.',
        start_url: '/',
        display: 'browser',
